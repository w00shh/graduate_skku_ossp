...
let software_check = {
    "oldMajorCore" : ["데이터베이스개론", "소프트웨어공학개론", "시스템프로그램", "알고리즘개론", "운영체제", "자료구조개론", "컴퓨터구조개론", "컴퓨터네트웍개론", "프로그래밍언어"],
    "oldMajorNormal" : ["팀프로젝트1", "팀프로젝트2", "팀프로젝트3", "컴파일러설계", "시스템시뮬레이션개론", "기계학습원론", "문제해결", "인공지능개론", "AI캡스톤디자인", "HCI개론", "ICT사업운영론", "ICT스타트업", "디지털논리회로", "멀티코어컴퓨팅",
    ...
    "oldExperiment" : ["소프트웨어실습1", "소프트웨어실습2", "소프트웨어실습3", "소프트웨어실습4", "운영체제프로젝트", "소프트웨어공학프로젝트", "컴퓨터그래픽스프로젝트", "JAVA프로그래밍실습", "네트워크프로젝트", "데이터베이스프로젝트",
    "모바일앱프로그래밍실습", "시스템프로그래밍실습", "오픈소스소프트웨어실습", "웹프로그래밍실습", "인공지능프로젝트", "임베디드시스템프로젝트"],
    
    "newMajorCore" : ["데이터베이스개론", "소프트웨어공학개론", "시스템프로그램", "알고리즘개론", "운영체제", "자료구조개론", "컴퓨터구조개론", "컴퓨터네트웍개론", "프로그래밍언어", "기계학습원론", "문제해결", "인공지능개론"],
    "newMajorNormal" : ["AI캡스톤디자인", "HCI개론", "ICT사업운영론", "ICT스타트업", "디지털논리회로", "멀티코어컴퓨팅", "모델링과시뮬레이션", "빅데이터분석방법론", "산학협력프로젝트1", "산학협력프로젝트2", "산학협력프로젝트3",
    ...
    "newExperiment" : ["JAVA프로그래밍실습", "네트워크프로젝트", "데이터베이스프로젝트", "모바일앱프로그래밍실습", "시스템프로그래밍실습", "오픈소스소프트웨어실습", "웹프로그래밍실습", "인공지능프로젝트", "임베디드시스템프로젝트"]
}

let GE_check = {
    "16" : {"16Insung" : ["성균논어", "인성고전"],
    "16Leadership" : ["실천리더십", "앙트레프레너십과리더십", "이론리더십"],
    "16Communication" : ["과학기술글쓰기", "담화와언어", "미디어글쓰기", "발표와매체언어", "발표와토의", "스피치와토론", "시민법정토론", "의사소통1", "의사소통2", "의사소통3", "의사소통4",
    "창의적글쓰기", "학술적글쓰기", "한국어말소리와언어예절", "한국어매체읽기", "한국어문서작성", "여행과글쓰기", "한국어화법과예절", "발표와토론1", "발표와토론2"],
    "16Creativity" : ["사고와표현", "창의와사유의기초", "창의적사고", "창의적융합디자인", "기호논리학", "비판적사고", "통계적사고", "일반논리학", "수리적사고", "창의적발상", "창의성이해", "창의와컴퓨팅사고", "창의와소프트웨어"],
    "16SwBasic" : ["공학컴퓨터프로그래밍", "프로그래밍기초와실습", "컴퓨팅사고와SW코딩","문제해결과알고리즘", "AI기초와활용"],
    "16EnglishBasic" : ["영어쓰기", "영어발표"],
    "16EnglishExpert" : ["고급영어쓰기", "과학영어", "글로벌시대의문화이해", "글로벌영어", "글로벌화와21세기중국", "뉴스와미디어의이해", "동아시아역사와문화", "문예영어", "미국사회와법", "법률영어", "비즈니스영어", "스페인어문화권의사회와문화",
    "스포츠영어", "앙트레프레너십영어", "영어토론", "유럽사회와문화", "이슬람세계의사상과문화", "인도문명권의사상과문화", "커리어영어", "한국문화와언어", "현대사회의인권과평등", "현대세계와글로벌시각", "현대중국사회의이해", "시사영어", "중앙아시아와몽골의이해"],
    "16Human" : ["주역과현대문명", "근대동아시아비교문화론", "몸과문화", "미학과창의경영", "MBSR명상", "게임과인문학 ", "고전속의자유", "고전속의행복", "그리스로마신화의이해", "기후변화와인문학", "노벨문학상과인문융합", "논어와인생", "다큐멘터리영화비평",
    ...
    "16Society" : ["사회심리학", "정보사회의이해","현대사회의이해", "현대사회와직업", "가족과생활환경", "자치와협동의사회과학", "한국생활의안내및진로지도1", "국제인권", "동아시아역사와문화", "4차산업혁명과법의이해", "AI와경영의사결정", "ESG경영", "경제학의고전과현대적이슈",
    ...
    "16Science" : ["과학기술과인간문화", "인간과자연환경", "창업이론과실제", "실학과수원화성의과학성이해", "동아시아과학사상의기초", "한국문화와창업가정신", "코스모스와인간", "마음뇌컴퓨터", "인공지능의이해", "4차산업혁명과과학문화", "테크놀러지의철학적이해", "특허와창업",
    ...
    "16ScienceBasic" : ["고급미분적분학1", "고급미분적분학2", "고급생명과학1", "고급생명과학2", "공학수학1", "공학수학2", "미분적분학1", "미분적분학2", "빅데이터와통계학", "생명과학1", "생명과학2", "선형대수학", "이산수학", "일반물리학1", "일반물리학2", "일반화학1",
    "일반화학2", "확률및통계", "미분적분학실습1", "미분적분학실습2", "생명과학실험1", "생명과학실험2", "일반물리학실험1", "일반물리학실험2", "일반화학실험1", "일반화학실험2"]},


    "17" : {"17Insung" : ["성균논어", "인성고전"],
    "17Leadership" : ["실천리더십", "앙트레프레너십과리더십", "이론리더십"],
    "17Communication" : ["과학기술글쓰기", "담화와언어", "미디어글쓰기", "발표와매체언어", "발표와토의", "스피치와토론", "시민법정토론", "의사소통1", "의사소통2", "의사소통3", "의사소통4",
    "창의적글쓰기", "학술적글쓰기", "한국어말소리와언어예절", "한국어매체읽기", "한국어문서작성", "여행과글쓰기", "한국어화법과예절", "발표와토론1", "발표와토론2"],
    "17Creativity" : ["사고와표현", "창의와사유의기초", "창의적사고", "창의적융합디자인", "기호논리학", "비판적사고", "통계적사고", "일반논리학", "수리적사고", "창의적발상", "창의성이해", "창의와컴퓨팅사고"],
    "17EnglishBasic" : ["영어쓰기", "영어발표"],
    "sixteeEnglishExpert" : ["고급영어쓰기", "과학영어", "글로벌시대의문화이해", "글로벌영어", "글로벌화와21세기중국", "뉴스와미디어의이해", "동아시아역사와문화", "문예영어", "미국사회와법", "법률영어", "비즈니스영어", "스페인어문화권의사회와문화",
    "스포츠영어", "앙트레프레너십영어", "영어토론", "유럽사회와문화", "이슬람세계의사상과문화", "인도문명권의사상과문화", "커리어영어", "한국문화와언어", "현대사회의인권과평등", "현대세계와글로벌시각", "현대중국사회의이해", "시사영어", "중앙아시아와몽골의이해"],
    "17Human" : ["주역과현대문명", "근대동아시아비교문화론", "몸과문화", "미학과창의경영", "MBSR명상", "게임과인문학 ", "고전속의자유", "고전속의행복", "그리스로마신화의이해", "기후변화와인문학", "노벨문학상과인문융합", "논어와인생", "다큐멘터리영화비평",
    "대중예술의이해", "대중음악의이해", "독일문화의이해", "동서양의세계유산", "동서양인문전통속의감정과윤리", "동서양지식문화의이해", "동아시아문학의이해", "동아시아의상호소통과한자문명", "동아시아의전통사상", "동양의예술과삶", "동양의지혜",
    "디지털시대의융합예술", "러시아문화의이해", "명상과치유", "문예창작의이해", "문화사와철학사상", "문화인류학", "뮤지컬과오페라", "북유럽신화의이해", "비교종교학의이해", "사랑과문학", "사랑의심리", "생명의료윤리", "성의심리학", "세계의정원과문화", "시문학과예술가곡",
    "아동의심리와교육", "여성의역사와문학,예술", "연극과문화", "영미문화의이해", "예술과4차산업혁명", "예술로보는동아시아", "예술사", "예술사와철학사상", "예술의말과생각", "유럽고도의역사와문화", "음악의이해", "인문학고전읽기", "일본문화의이해", "종교와유럽문화", "죽음과문화",
    "중국문화의이해", "지식정보학", "프랑스문화의이해", "프로이트와현대문화", "한국고전문학", "한국과중국", "한국문화의이해", "한국사상과문화의이해", "한국사회와미디어", "한국의문화유산과공간", "한국현대문학", "한시의이해", "한자와한문의세계",
    "신화와교육", "여가와축제의문화", "디지털시대의영상예술", "인문지리학", "언어와현대사회", "기계비평론"],
    "17Society" : ["사회심리학", "정보사회의이해","현대사회의이해", "현대사회와직업", "가족과생활환경", "자치와협동의사회과학", "한국생활의안내및진로지도1", "국제인권", "동아시아역사와문화", "4차산업혁명과법의이해", "AI와경영의사결정", "ESG경영", "경제학의고전과현대적이슈",
    "고전속의미디어와언론의자유", "고전속의정의", "공학경제", "근대성과현대문화", "글로벌무역의이해", "기술시대의회계", "기업가정신", "기업과증권시장의이해", "나와역사", "다문화사회의이해", "대격변의시대", "대중매체의이해", "동양의역사와문명", "미디어와윤리",
    "미래사회와창의혁신인재", "민주사회와행정", "북한경제의이해", "사회과학고전읽기", "서양의역사와문명", "성격과적응", "세계사속의중국", "소비와윤리", "여성과사회", "유교자본주의의이해", "인간과토지의문명사", "인구와가족의역사", "일상생활의역사", "전쟁과문화",
    "정치경제학의이해", "직업생활과법", "통일문제의이해", "한국경제의이해", "한국사개설", "한국사회풍속사", "한국역사의이해", "한국전통사회의정치문화", "현대가족의이해", "현대동아시아정치경제변동", "현대민주주의의이해", "현대사회와법", "현대사회와법의정신", "현대사회와복지",
    "현대사회와헌법의이해", "현대사회유학의이해", "현대사회의문제", "현대중국사회와문화", "현대한국정치의쟁점", "생활속의통계", "시민사회와시민운동", "글로벌시대의여성과남성", "이공계경영학"],
    "17Science" : ["과학기술과인간문화", "인간과자연환경", "창업이론과실제", "실학과수원화성의과학성이해", "동아시아과학사상의기초", "한국문화와창업가정신", "코스모스와인간", "마음뇌컴퓨터", "인공지능의이해", "4차산업혁명과과학문화", "테크놀러지의철학적이해", "특허와창업",
    "산업혁명과사회문화", "우주론", "문명과자연환경", "과학기술과사회윤리", "과학기술산업화의역사", "약과건강", "생활속의양자", "생태계와환경", "생활속의화학", "암의과학", "인간-컴퓨터상호작용의이해", "과학기술과창업경영", "현대천문학개론", "스포츠마케팅과미디어", "과학사",
    "화학과생명현상", "생명진화의철학", "환경과건강", "기후와문화", "자연과학고전읽기", "융복합시대의창업", "생활속의에너지", "운동과건강", "유전자재조합의이해", "인공지능을위한기초수학", "생명의기원과본질", "지속가능에너지화학", "생명공학의이해",
    "생명과음식의과학", "생명의과학", "법의학으로보는사회의이해", "핵과학과핵에너지", "진화학입문", "과학미디어와문화"],
    "17ScienceBasic" : ["공학컴퓨터프로그래밍", "프로그래밍기초와실습", "고급미분적분학1", "고급미분적분학2", "고급생명과학1", "고급생명과학2", "공학수학1", "공학수학2", "미분적분학1", "미분적분학2", "빅데이터와통계학", "생명과학1", "생명과학2", "선형대수학", "이산수학", "일반물리학1", "일반물리학2", "일반화학1",
    "일반화학2", "확률및통계", "미분적분학실습1", "미분적분학실습2", "생명과학실험1", "생명과학실험2", "일반물리학실험1", "일반물리학실험2", "일반화학실험1", "일반화학실험2"]},


    "20" : {"20Insung" : ["성균논어", "실천리더십", "앙트레프레너십과리더십"],
    "20Classic" : ["고전명저북클럽"],
    "20Communication" : ["과학기술글쓰기", "담화와언어", "미디어글쓰기", "발표와매체언어", "발표와토의", "스피치와토론", "시민법정토론", "발표와토론1", "발표와토론2", "의사소통1", "의사소통2", "의사소통3", "의사소통4", "창의적글쓰기", "학술적글쓰기", "한국어말소리와언어예절", "한국어매체읽기", "한국어문서작성"],
    "20Creativity" : ["사고와표현", "창의와사유의기초", "창의적발상", "창의적사고", "창의적융합디자인"],
    "20Future" : ["공학컴퓨터프로그래밍", "프로그래밍기초와실습", "컴퓨팅사고와SW코딩", "문제해결과알고리즘", "AI기초와활용"],
    "20Global" : ["고급영어쓰기", "과학영어", "글로벌시대의문화이해", "글로벌영어", "글로벌화와21세기중국", "뉴스와미디어의이해", "동아시아역사와문화", "문예영어", "미국사회와법", "법률영어", "비즈니스영어", "스페인어문화권의사회와문화", "스포츠영어", "앙트레프레너십영어",
    "영어토론", "영어발표", "유럽사회와문화", "이슬람세계의사상과문화", "인도문명권의사상과문화", "커리어영어", "한국문화와언어", "현대사회의인권과평등", "현대세계와글로벌시각", "현대중국사회의이해", "영어쓰기"],
    "20Human" : ["MBSR명상", "게임과인문학 ", "고전속의자유", "고전속의행복", "그리스로마신화의이해", "기후변화와인문학", "노벨문학상과인문융합", "논어와인생", "다큐멘터리영화비평", "대중예술의이해", "대중음악의이해", "독일문화의이해", "동서양의세계유산", "동서양인문전통속의감정과윤리",
    ...
    "20Society" : ["4차산업혁명과법의이해", "AI와경영의사결정", "ESG경영", "가족과생활환경", "경제학의고전과현대적이슈", "고전속의미디어와언론의자유", "고전속의정의", "공학경제", "국제인권", "근대성과현대문화", "글로벌무역의이해", "기술시대의회계", "기업가정신", "기업과증권시장의이해", "나와역사",
    ...
    "20Science" : ["4차산업혁명과과학문화", "테크놀러지의철학적이해", "특허와창업", "산업혁명과사회문화", "우주론", "문명과자연환경", "과학기술과사회윤리", "과학기술산업화의역사", "약과건강", "생활속의양자", "생태계와환경", "생활속의화학", "암의과학",
    ...
    "20ScienceBasic" : ["고급미분적분학1", "고급미분적분학2", "고급생명과학1", "고급생명과학2", "공학수학1", "공학수학2", "미분적분학1", "미분적분학2", "빅데이터와통계학", "생명과학1", "생명과학2", "선형대수학", "이산수학", "일반물리학1", "일반물리학2", "일반화학1", "일반화학2",
    "확률및통계", "미분적분학실습1", "미분적분학실습2", "생명과학실험1", "생명과학실험2", "일반물리학실험1", "일반물리학실험2", "일반화학실험1", "일반화학실험2"]},

    
    "21" : {"21Insung" : ["성균논어", "실천리더십", "앙트레프레너십과리더십"],
    "21Classic" : ["고전명저북클럽"],
    "21Communication" : ["과학기술글쓰기", "담화와언어", "미디어글쓰기", "발표와매체언어", "발표와토의", "스피치와토론", "시민법정토론", "의사소통1", "의사소통2", "의사소통3", "의사소통4", "창의적글쓰기", "학술적글쓰기", "한국어말소리와언어예절", "한국어매체읽기", "한국어문서작성"],
    "21Creativity" : ["사고와표현", "창의와사유의기초", "창의적사고", "창의적융합디자인"],
    "21Ds" : ["공학컴퓨터프로그래밍", "프로그래밍기초와실습", "AI기초와활용", "데이터분석기초"],
    "21Global" : ["고급영어쓰기", "과학영어", "글로벌시대의문화이해", "글로벌영어", "글로벌화와21세기중국", "뉴스와미디어의이해", "동아시아역사와문화", "문예영어", "미국사회와법", "법률영어", "비즈니스영어", "스페인어문화권의사회와문화", "스포츠영어", "앙트레프레너십영어",
    "영어토론", "영어발표", "유럽사회와문화", "이슬람세계의사상과문화", "인도문명권의사상과문화", "커리어영어", "한국문화와언어", "현대사회의인권과평등", "현대세계와글로벌시각", "현대중국사회의이해", "영어쓰기"],
    "21Total" : ["MBSR명상", "게임과인문학 ", "고전속의자유", "고전속의행복", "그리스로마신화의이해", "기후변화와인문학", "노벨문학상과인문융합", "논어와인생", "다큐멘터리영화비평", "대중예술의이해", "대중음악의이해", "독일문화의이해", "동서양의세계유산", "동서양인문전통속의감정과윤리",
    ...
    "21TotalBasic" : ["경제학입문", "기초독어1", "기초독어2", "기초러시아어1", "기초러시아어2", "기초일본어1", "기초일본어2", "기초중국어1", "기초중국어2", "기초프랑스어1", "기초프랑스어2", "기초한문", "동양사상입문", "라틴어", "문학입문", "사회과학입문", "사회학입문", "심리학입문",
