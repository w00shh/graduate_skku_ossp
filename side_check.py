...
{'communication' : ['과학기술글쓰기', '담화와언어', '미디어글쓰기', '발표와매체언어', '발표와토의', '스피치와토론', '시민법정토론',
'의사소통1', '의사소통2', '의사소통3', '의사소통4', '창의적글쓰기', '학술적글쓰기', '한국어말소리와언어예절', '한국어매체읽기', '한국어문서작성', '여행과글쓰기', '한국어화법과예절', '발표와토론1', '발표와토론2']}, 
...
{'society' : ['4차산업혁명과법의이해', 'AI와경영의사결정', 'ESG경영', '경제학의고전과현대적이슈', '고전속의미디어와언론의자유', '고전속의정의', '공학경제', '근대성과현대문화', '글로벌무역의이해', '기술시대의회계', '기업가정신', '기업과증권시장의이해', '나와역사',
...
'인간과토지의문명사', '인구와가족의역사', '일상생활의역사', '전쟁과문화', '정치경제학의이해', '직업생활과법', '통일문제의이해', '한국경제의이해', '한국사개설', '한국사회풍속사', '한국역사의이해', '한국전통사회의정치문화', '현대가족의이해',
...
'인공지능을위한기초수학', '생명의기원과본질', '지속가능에너지화학', '생명공학의이해', '생명과음식의과학', '생명의과학', '법의학으로보는사회의이해', '핵과학과핵에너지']},
